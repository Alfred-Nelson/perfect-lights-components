        ...
        <div className='flex flex-col justify-center  space-y-0 items-center text-white h-[auto] '>
            <div className="flex flex-col justify-center w-[42%] text-center py-32">
                <div className="flex flex-col justify-center items-center space-y-12">
                    <motion.h1 initial={{ x: -100, opacity: 0 }} whileInView={{ x: 0, opacity: 1, transition: { type: "spring", bounce: 0.5, duration: 1 } }} viewport={{ once: false, amount: 0.5 }} className='text-center text-7xl text-[#E1E1E1] tracking-tight font-bold'>Product Customization</motion.h1>
                    <motion.p initial={{ x: 100, opacity: 0 }} whileInView={{ x: 0, opacity: 1, transition: { type: "spring", bounce: 0.5, duration: 1 } }} viewport={{ once: false, amount: 0.5 }} className='text-[#DBDBDB]'>
