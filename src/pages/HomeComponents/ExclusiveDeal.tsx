    ...
    return (
        <div className='flex flex-col space-y-0 bg-pot-grey1 px-0 py-12'>
            <div className='h-auto flex justify-center space-x-12 items-center w-full   text-xl text-[#4E4E4E]'>
                <div
                    className='flex justify-center  w-[20%] -mt-28 text-left h-auto '
                >
                    <p>
                ...
                <div className='flex justify-center items-center w-[400px] h-[410px]'>
                    <img className="  w-[full] h-[full] object-cover " src="https://www.seekpng.com/png/detail/760-7601507_theatre-lights-prolights-eclipsehdtubk-etc-source-4-png.png" alt="Theatre Lights Prolights Eclipsehdtubk - Etc Source 4 Png@seekpng.com"></img>
                </div>
            ...
            <div  >
                <p className='text-center text-[55px] tracking-tight font-bold leading-12'>Exclusive Deals of Lights Collection</p>
            </div>
        </div>
    )
}
