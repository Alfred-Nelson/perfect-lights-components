...
export const primaryStyle: string =
    "bg-pot-yellow text-white stroke-white hover:bg-pot-grey5 active:bg-pot-grey2 ease-in-out transition";
...
export const secondaryStyle: string =
    "bg-pot-grey5 text-white border-2 border-pot-grey5 stroke-white hover:bg-white hover:text-black hover:border-2 hover:border-pot-grey5 active:bg-pot-grey2  active:text-white active:border-none ease-in-out transition";

export const secondaryOutlineStyle: string =
    "bg-white text-black stroke-white border-2 border-pot-grey5 hover:bg-pot-grey5 hover:text-white active:bg-pot-grey2  active:text-white active:border-none ease-in-out transition disabled:opacity-75";
